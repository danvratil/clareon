...
///
/// Used by OpenAI and LiteLLM providers.
...
impl OpenAiBackend {
    /// Create a new OpenAI-compatible backend from provider configuration
    pub fn from_config(config: &OpenAiBackendConfig) -> Self {
